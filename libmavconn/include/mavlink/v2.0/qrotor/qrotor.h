...
#define MAVLINK_MESSAGE_CRCS {{0, 50, 9, 9, 0, 0, 0}, {180, 99, 25, 25, 0, 0, 0}, {181, 60, 32, 32, 0, 0, 0}, {182, 153, 44, 44, 0, 0, 0}, {183, 208, 24, 24, 0, 0, 0}, {184, 149, 24, 24, 0, 0, 0}, {300, 217, 22, 22, 0, 0, 0}}
#endif
...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_HEARTBEAT, MAVLINK_MESSAGE_INFO_OFFBOARD_CONTROL, MAVLINK_MESSAGE_INFO_POWER_READINGS, MAVLINK_MESSAGE_INFO_ONBOARD_IMU, MAVLINK_MESSAGE_INFO_INPUT_SI, MAVLINK_MESSAGE_INFO_INPUT_PWM, MAVLINK_MESSAGE_INFO_PROTOCOL_VERSION}
# define MAVLINK_MESSAGE_NAMES {{ "HEARTBEAT", 0 }, { "INPUT_PWM", 184 }, { "INPUT_SI", 183 }, { "OFFBOARD_CONTROL", 180 }, { "ONBOARD_IMU", 182 }, { "POWER_READINGS", 181 }, { "PROTOCOL_VERSION", 300 }}

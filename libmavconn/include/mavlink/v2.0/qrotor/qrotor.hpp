 ...
 */
constexpr std::array<mavlink_msg_entry_t, 5> MESSAGE_ENTRIES {{ {0, 50, 9, 9, 0, 0, 0}, {180, 21, 21, 21, 0, 0, 0}, {181, 60, 32, 32, 0, 0, 0}, {182, 153, 44, 44, 0, 0, 0}, {300, 217, 22, 22, 0, 0, 0} }};
